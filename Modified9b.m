%% This code is a modifThis code is a modification of arrays_final_scores_9b.m 
%% It expects an array of one column as input
close all;
clear all;
%
...
%
load newdatafile
sizefse = size(finalscoresexample1)

% extract numbers in column 11
% display scores
%
col11 = finalscoresexample1(:,1)  %% I modified this line to expect a single
[r c] = size(col11)              %% column 
figure(1);
