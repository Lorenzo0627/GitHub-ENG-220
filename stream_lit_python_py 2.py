# -*- coding: utf-8 -*-
"""Stream lit python.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Cu5ml47qh9uGOpOvK2NoghNQJdK1Ezgu
"""
...
if uploaded_file is not None:
    ...
    st.write("The columbs show be organized to what they need to be.")
else:
    st.info("CSV file has been uploaded with the python code.")
